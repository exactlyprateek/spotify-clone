...
function Home() {
	...
	const options = [
		...
		},
		{
			...
			musicSrc:
				'https://res.cloudinary.com/dzjtgtjaj/video/upload/v1622807915/All_Apologies_-_Nirvana_eurvxg.mp3',
			cover:
				'https://res.cloudinary.com/dzjtgtjaj/image/upload/v1622808216/R-1003299-1423912611-3812.jpeg_yow2zv.jpg'
		},
		{
		...
		},
		{
			...
			musicSrc:
				'https://res.cloudinary.com/dzjtgtjaj/video/upload/v1622807971/Trevor_Daniel_-_Falling_bkxbql.mp3',
		...
		{
			name: 'Green Day - Wake Me Up',
			musicSrc:
				'https://res.cloudinary.com/dzjtgtjaj/video/upload/v1622809243/Green_Day-Wake_Me_Up_When_September_Ends_lyrics_t5qqof.mp3',
			cover:
				'https://res.cloudinary.com/dzjtgtjaj/image/upload/v1622812631/eg59zpr3_jpllki.jpg'
		},
		{
			name: 'Radiohead - Creep',
			musicSrc:
				'https://res.cloudinary.com/dzjtgtjaj/video/upload/v1622809690/Radiohead_-_Creep_dxy9jp.mp3',
			cover:
				'https://res.cloudinary.com/dzjtgtjaj/image/upload/v1622810276/Radiohead_original_creep_cover_eiwjjp.jpg'
		},
		{
			name: 'JOJI - RIP',
			musicSrc:
				'https://res.cloudinary.com/dzjtgtjaj/video/upload/v1622809749/Joji_-_RIP_xlnmdy.mp3',
			cover:
		...
		},
		{
			...
			cover:
				'https://res.cloudinary.com/dzjtgtjaj/image/upload/v1622810266/Bohemian_Rhapsody_npe9k0.png'
		},
		{
			name: 'Selena Gomez - Only You',
			musicSrc:
				'https://res.cloudinary.com/dzjtgtjaj/video/upload/v1622810425/Only_You_r45otv.mp3',
			cover:
		...
		},
		{
			...
			musicSrc:
				'https://res.cloudinary.com/dzjtgtjaj/video/upload/v1622810528/Sleeping_At_Last_Saturn_zmnkff.mp3',
			cover:
	...
	return (
		<div style={{ overflow: 'hidden', maxHeight: '100vh' }}>
			...
			<HStack style={{ maxHeight: '100%', minHeight: '100vh', background: '#212121' }}>
				<Box w="16vw" minH="100vh" h="100%" bg="#121212" d="flex" justifyContent="center">
					<VStack mt="4" w="12vw">
						<NavButton text="Home" />
				...
				>
					...
					<SimpleGrid minChildWidth="280px" columns={[ 1, 2, 4, 4 ]}>
						{[0,1,2,3,4,5,6,7].map((i, idx) => (
							<div onClick={() => setTrack(i)}>
								<SongButton title={options[i].name} cover={options[i].cover} id={`${i}`} />
							</div>
						))}
					</SimpleGrid>
					...
					<SimpleGrid minChildWidth="15rem" columns={[ 1, 2, 4, 4 ]}>
						...
						<div onClick={() => setTrack(i)}>
						<SongCard id={`${i}`} cover={options[i].cover} title={options[i].name} /></div>))}
					</SimpleGrid>
				</Container>{' '}
			</HStack>
			<Box
